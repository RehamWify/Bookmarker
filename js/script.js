...
var boxModal = document.querySelector(".message-box");
var bookmarks = [];
...
//     Making sure that user enter the correct data or not with regex

// A more comprehensive regex for URL validation
    // This regex checks for:
    // 1. Optional protocol (http, https, ftp, sftp)
    // 2. Domain name (including subdomains, internationalized domain names)
    // 3. Optional port number
    // 4. Optional path, query string, and fragment
